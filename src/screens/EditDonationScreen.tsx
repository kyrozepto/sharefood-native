...
const mockDonation = {
  ...
  description:
    "A variety of fresh vegetables including carrots, potatoes, and onions. All vegetables are in good condition and were purchased yesterday.",
  quantity: "5kg",
  expiryTime: "2 hours",
  location: "123 Main St, City",
  image:
    "https://images.pexels.com/photos/3872406/pexels-photo-3872406.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
};
    ...
    <SafeAreaView style={globalStyles.safeArea}>
      ...
      >
        ...
        <View style={styles.inputContainer}>
          ...
          />
          {errors.expiryTime ? (
            <Text style={styles.errorText}>{errors.expiryTime}</Text>
          ) : null}
        </View>
